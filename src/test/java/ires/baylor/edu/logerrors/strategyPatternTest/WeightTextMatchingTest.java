    ...
    static List<Double> weights = new ArrayList<>() {
        {
            ...
            add(0.5);
            add(0.5);
            add(0.5);  add(0.5); add(0.5); add(0.5); add(0.0); add(0.0); add(1.0); add(1.0); add(1.0); add(1.0);
            add(1.0);
            add(1.0); add(0.0); add(1.0); add(1.0); add(1.0);
            add(0.0);
            add(1.0); add(1.0); add(0.0);  add(1.0); add(1.0); add(1.0);  add(1.0);
            add(1.0); add(1.0); add(1.0); add(1.0); add(1.0); add(0.0); add(0.0); add(0.5); add(0.5);
            add(0.5); add(0.5);  add(0.5); add(0.0);
        };
    };
